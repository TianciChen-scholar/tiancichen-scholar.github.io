...
[![tiancichen-scholar](https://img.shields.io/badge/tiancichen--scholar-GitHub-blue?logo=github)](https://github.com/tiancichen-scholar)

 My research interests center on <strong>computational communication</strong>,<strong>digital media</strong>, and <strong>political communication</strong>.I study how communication cues in digital media shape what audiences notice, how they interpret public and political messages, and how they respond to them. Methodologically, I use computational social science methods and experimental designs to develop computational measures of these cues and examine their communication effects. I am also interested in the use of large language models in communication research, particularly the validity of using LLMs to measure communication constructs and generate experimental stimuli.
